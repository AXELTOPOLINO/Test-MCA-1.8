...
public class MCAModelRenderer extends ModelRenderer
{
	...
	public ModelRenderer addBox(String par1Str, float par2, float par3, float par4, int par5, int par6, int par7)
	{
		...
		cubeList.add(new MCAModelBox(this, textureOffsetX, textureOffsetY, par2, par3, par4, par5, par6, par7, 0.0F).func_78244_a(par1Str));
		return this;
	}
	...
	{
		cubeList.add(new MCAModelBox(this, textureOffsetX, textureOffsetY, par1, par2, par3, par4, par5, par6, 0.0F));
		return this;
	}
	...
	{
		cubeList.add(new MCAModelBox(this, textureOffsetX, textureOffsetY, par1, par2, par3, par4, par5, par6, par7));
	}
		...
		if (!isHidden)
		{
			if (showModel)
			{
				...
				else
				{
					GL11.glPushMatrix();
					GL11.glTranslatef(rotationPointX * par1, rotationPointY * par1, rotationPointZ * par1);
					FloatBuffer buf = Utils.makeFloatBuffer(rotationMatrix.intoArray());
	...
	public void DDScompileDisplayList(float par1)
	{
		...
		{
			((ModelBox) cubeList.get(i)).render(worldRenderer, par1);
		}
